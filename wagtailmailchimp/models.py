...
from .widgets import MailchimpSubscriberIntegrationWidget, MailchimpSubscriberOptinWidget, MailchimpAudienceListWidget
...
class AbstractMailchimpIntegrationForm(AbstractForm, models.Model):
    ...
    form_fields_field_name = 'form_fields'
    ...
    enable_mailing_list_subscription = models.BooleanField(default=False,
                                                           verbose_name=_("Enable Mailing list subscription"))
